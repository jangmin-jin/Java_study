...
import com.exam.member01.MemberDAO;
import com.exam.member01.MemberTO;
...
public class MemberInsertDialog extends JDialog {
...
//						System.out.println(groupName);
						...
						// 입력값 검사
						if(name.equals("")) {
							JOptionPane.showMessageDialog(MemberInsertDialog.this, "필수 항목을 입력해야합니다.", "에러", JOptionPane.WARNING_MESSAGE);
							...
							if(dao.insertMember(to)){
								MemberInsertDialog.this.dispose();
							} else {
								JOptionPane.showMessageDialog(MemberInsertDialog.this, "입력 에러.", "에러", JOptionPane.WARNING_MESSAGE);
							}
